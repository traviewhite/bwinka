...
import { bwinkaSlide, eiuSlide, eiuSlide2, eiuSlide3, macSlide, blueroomSlide, portlandSlide, postersSlide } from './image_data'
...
export default () => {
  return [SlideshowBwinka, SlideshowEIU, SlideshowEIU2, SlideshowEIU3, SlideshowMac, SlideshowBlueroom, SlideshowPortland, SlideshowPosters ]
}
